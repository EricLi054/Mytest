...
import { IconButton, Stack, styled, Tooltip, tooltipClasses, type TooltipProps, Typography } from '@mui/material';
import FontAwesomeIcon from '../FontAwesomeIcon';
import { colors } from '@racwa/styles';

interface PromotionalTooltipProps extends Omit<TooltipProps, 'title'> {
  tooltipOpen: boolean;
  closeTooltip: () => void;
}
