'use client';
import { Box, type Breakpoint, styled, Typography } from '@mui/material';
import { colors } from '@racwa/styles';
import RacwaLogo from '../RacwaLogo';
...
export const StyledMemberDisplayName = styled(Typography)(({ theme }) => ({
  fontWeight: '400',
