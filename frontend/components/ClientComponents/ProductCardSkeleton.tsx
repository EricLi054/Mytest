...
export default function ProductCardSkeleton() {
  const productHeader = useMemo(() => {
    return (
      <Grid container item direction='column' gap={2} width={{ xs: 'auto', md: '100%' }}>
        <StyledTitleSkeleton />
    ...
    return (
      <Grid container direction={{ xs: 'column', md: 'row' }} rowSpacing={2.5} columnSpacing={3}>
        <Grid container item direction='column' xs={6} rowSpacing={2.5} columnSpacing={3}>
          ...
          <Grid container item direction='column' gap={1.5}>
            <StyledPolicyDataSkeleton width={theme.spacing(8)} />
            <StyledPolicyDataSkeleton width={theme.spacing(15)} />
          </Grid>
        </Grid>
        <Grid container item direction='column' xs={6} rowSpacing={2.5} columnSpacing={3}>
          <Grid container item direction='column' gap={1.5}>
