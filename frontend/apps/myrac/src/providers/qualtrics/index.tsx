...
const Qualtrics = () => {
  return (
    <>
      <Script id="qualtricsCode" type="text/javascript" strategy="afterInteractive">
        {`
      ...
      {/* Placed outside the conditional to prevent hydration errors */}
      <div id="ZN_3G35vXJpcMHXWrn" />
    </>
  );
};
