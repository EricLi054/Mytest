...
describe("ProductUpdateNotAllowed", () => {
  it("should be able to render", async () => {
    ...
    expect(screen.getByText(mockUpdateNotAllowedContentfulData.rac_stepperFormErrorPage.heading)).toBeVisible();
    expect(screen.getByText(mockUpdateNotAllowedContentfulData.rac_stepperFormErrorPage.subheading)).toBeVisible();
